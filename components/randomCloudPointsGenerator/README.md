...
## Dependencies
The following dependencies are required to build and run randomCloudPointsGenerator. Ensure they are installed and properly configured on your system before proceeding:
```
<YOUR DEPENDENCIES>
```

## Configuration parameters
Like any other component, randomCloudPointsGenerator requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
```bash
cd <randomCloudPointsGenerator's path> 
...
bin/randomCloudPointsGenerator etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of randomCloudPointsGenerator, including what can be modified and how to use key features.
## Editable Files
