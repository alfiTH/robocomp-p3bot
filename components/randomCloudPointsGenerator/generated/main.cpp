...
/** \mainpage RoboComp::randomCloudPointsGenerator
 *
 * \section intro_sec Introduction
 *
 * The randomCloudPointsGenerator component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/randomCloudPointsGenerator --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "randomCloudPointsGenerator"
#define SERVER_FULL_NAME   "RoboComp randomCloudPointsGenerator::randomCloudPointsGenerator"
...
class randomCloudPointsGenerator : public Ice::Application
{
public:
	randomCloudPointsGenerator (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData randomCloudPointsGenerator::getInitializationDataIce(){
...
void randomCloudPointsGenerator::initialize()
{
...
int randomCloudPointsGenerator::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	randomCloudPointsGenerator app(configFile, prefix, startup_check_flag);
