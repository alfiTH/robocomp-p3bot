...
/** \mainpage RoboComp::simpleNavigator
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/simpleNavigator --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "simpleNavigator"
#define SERVER_FULL_NAME   "RoboComp simpleNavigator::simpleNavigator"
...
class simpleNavigator : public Ice::Application
{
public:
	simpleNavigator (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData simpleNavigator::getInitializationDataIce(){
...
void simpleNavigator::initialize()
{
...
int simpleNavigator::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	simpleNavigator app(configFile, prefix, startup_check_flag);
