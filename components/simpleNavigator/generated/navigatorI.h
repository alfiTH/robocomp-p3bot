...
public:
	...
	RoboCompNavigator::TPose gotoPose(RoboCompNavigator::TPose pose, const Ice::Current&);
...
private:
	...
	std::array<std::function<RoboCompNavigator::TPose(RoboCompNavigator::TPose&)>, 1> gotoPoseHandlers;
